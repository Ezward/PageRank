...
public final class SparseDoubleVector
{
    ...
    private final double[] values;  // the corresponding element value
    public final double zero;      // the default value for elements that are not set.
     ...
     */
    public SparseDoubleVector(final int theCardinality)
    {
        this(theCardinality, 0.0);
    }
     ...
     */
    public SparseDoubleVector(final int theCardinality, final double zero)
    {
        this.count = 0;
        this.zero = zero;
        this.indices = new int[theCardinality];
        this.values = new double[theCardinality];
    }
     ...
     */
    public boolean safeSet(final int theVectorIndex, final double theValue)
    {
     ...
     */
    private boolean insertAt(final int theArrayPosition, final int theVectorIndex, final double theValue)
    {
